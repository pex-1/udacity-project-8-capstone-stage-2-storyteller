package udacity.storyteller.UI.Storyboard;
...
import udacity.storyteller.UI.Fragments.CategoriesFragment;
import udacity.storyteller.UI.Fragments.Drafts;
import udacity.storyteller.UI.Fragments.MyStories;
...
public class Storyboard extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_storyboard, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Toast.makeText(this, R.string.signing_out, Toast.LENGTH_SHORT).show();
